                            ...
                            @if (count($positiones) > 0)
                                @foreach ($positiones as $position)
                                    <tr>
                                        ...
                                        <td><button wire:click="edit({{ $position->id }})" class="btn btn-success"><i class="fas fa-edit"></i></button></td>
                                        <td><button class="btn btn-danger" wire:click.prevent='delete({{ $position->id }})'><i class="fas fa-trash"></i></button></td>
