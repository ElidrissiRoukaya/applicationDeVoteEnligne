                                ...
                                @foreach ($voters as $voter)
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('storage') }}/{{ $voter->image }}"
                                                ...
                                                <td><button wire:click="edit({{ $voter->id }})" class="btn btn-success"><i class="fas fa-edit"></i></button></td>
                                                <td><button class="btn btn-danger" wire:click.prevent='delete({{ $voter->id }})'><i class="fas fa-trash"></i></button></td>
