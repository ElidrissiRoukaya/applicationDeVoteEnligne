...
<div>
    <x-slot:title >
        ...
        <x-slot:image_title>
            ...
            <div class="my-5">
                <h1 class="text-center titre-marron">Login For Voting</h1>
                    ...
                    <div class="row flex justify-content-center">
                        <div class="col-xl-6 col-lg-6 col-md-8 col-sm-12">
                            ...
                            <form wire:submit.prevent='login'>
                                <div class="mb-3 mt-3">
                                    <label for="id" class="form-label marron">Vote Id:</label>
                                ...
                                <div class="mb-3">
                                    <label for="pwd" class="form-label marron">Password:</label>
