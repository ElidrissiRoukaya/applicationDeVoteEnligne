                                ...
                                @foreach ($condidates as $condidate)
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('storage') }}/{{ $condidate->image }}"
                                                ...
                                                <td><a wire:click="edit({{ $condidate->id }})" class="btn btn-success"><i class="fas fa-edit"></i></a></td>
                                                <td><a class="btn btn-danger" wire:click.prevent='delete({{ $condidate->id }})'><i class="fas fa-trash"></i></a></td>
